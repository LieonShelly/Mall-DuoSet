...
@interface UserPiazzaDetailsHeaderView()
...
@implementation UserPiazzaDetailsHeaderView
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _bgImgView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, mainScreenWidth, FitHeight(446))];
