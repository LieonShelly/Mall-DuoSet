...
- (CGSize)collectionViewContentSize{
    ...
    CGSize size = CGSizeMake(0, [self.maxYDict[maxColumn] floatValue] + self.sectionInset.bottom);
    if (self.delegate && [self.delegate respondsToSelector:@selector(reSteCollectionViewContentSize:)]) {
        [self.delegate reSteCollectionViewContentSize:size];
    }
    return size;
}
