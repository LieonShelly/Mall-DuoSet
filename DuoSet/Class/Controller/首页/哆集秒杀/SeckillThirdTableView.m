...
@interface SeckillThirdTableView()<UITableViewDataSource, UITableViewDelegate>



@end

@implementation SeckillThirdTableView

+ (SeckillThirdTableView *)contentTableView{
    SeckillThirdTableView *contentTV = [[SeckillThirdTableView alloc] initWithFrame:CGRectMake(mainScreenWidth * 2, 0, [UIScreen mainScreen].bounds.size.width, mainScreenHeight - 64 - FitHeight(100)) style:UITableViewStyleGrouped];
