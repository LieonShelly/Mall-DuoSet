...
@interface SeckillFirstTableView()<UITableViewDataSource, UITableViewDelegate>

@end

@implementation SeckillFirstTableView

+ (SeckillFirstTableView *)contentTableView{
    SeckillFirstTableView *contentTV = [[SeckillFirstTableView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, mainScreenHeight - 64 - FitHeight(100)) style:UITableViewStyleGrouped];
