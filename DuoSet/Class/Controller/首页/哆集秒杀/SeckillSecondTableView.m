...
@interface SeckillSecondTableView()<UITableViewDataSource, UITableViewDelegate>



@end

@implementation SeckillSecondTableView

+ (SeckillSecondTableView *)contentTableView{
    SeckillSecondTableView *contentTV = [[SeckillSecondTableView alloc] initWithFrame:CGRectMake(mainScreenWidth, 0, [UIScreen mainScreen].bounds.size.width, mainScreenHeight - 64 - FitHeight(100)) style:UITableViewStyleGrouped];
