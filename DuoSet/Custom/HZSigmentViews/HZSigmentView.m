...
- (instancetype)initWithOrgin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    if (self) {
        ...
        self.titleFont = [UIFont systemFontOfSize:15]; // 字体大小
        self.btnArrys = [[NSMutableArray alloc] initWithCapacity:0];
        self.titleColorNormal = DDMColor(80, 80, 80); // 字体正常时颜色
        self.titleColorSelect = DDMColor(0, 181, 61); // 字体选择时颜色
        self.bottomLineColor = DDMColor(214, 214, 214); // 下划线背景颜色
        self.titleLineColor = DDMColor(0, 181, 61); // 下划线颜色
