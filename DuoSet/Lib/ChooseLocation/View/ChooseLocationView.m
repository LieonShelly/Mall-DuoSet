...
- (void)setUp{
    ...
    separateLine1.top = topTabbar.height - 0.5;
    ...
    _underLine.backgroundColor = [UIColor mainColor];
    UIScrollView * contentView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(topTabbar.frame), self.frame.size.width, self.height)];
...
- (void)addTopBarItem{
    ...
    [topBarItem setTitleColor:[UIColor mainColor] forState:UIControlStateSelected];
    [topBarItem sizeToFit];
    topBarItem.titleLabel.font = CUSNEwFONT(17);
