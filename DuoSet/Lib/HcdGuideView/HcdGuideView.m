...
- (UIPageControl *)pageControl {
    if (_pageControl == nil) {
        ...
        _pageControl.center = CGPointMake(kHcdGuideViewBounds.size.width / 2, kHcdGuideViewBounds.size.height - 30);
        [_pageControl setValue:[UIImage imageNamed:@"guide_page_contrl_nomal"] forKeyPath:@"pageImage"];
        [_pageControl setValue:[UIImage imageNamed:@"guide_page_contrl_seletced"] forKeyPath:@"currentPageImage"];
    }
    return _pageControl;
}
...
- (void)showGuideViewWithImages:(NSArray *)images
           ...
           andButtonBorderColor:(UIColor *)borderColor
             andShowPageControl:(BOOL)showPageControl{
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == self.images.count - 1) {
        ...
        [cell.button setBackgroundColor:[[UIColor whiteColor]colorWithAlphaComponent:0.5]];
