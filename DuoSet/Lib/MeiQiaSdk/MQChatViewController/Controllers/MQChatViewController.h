...
///chatViewStyle 预设的聊天界面样式 - 商品咨询
@property (nonatomic, strong) DuojiProductModel *productCellModel;

///chatViewStyle 预设的聊天界面样式 - 订单咨询
@property (nonatomic, strong) DuojiOrderModel *orderModel;
