...
@implementation DuojiProductModel

- (DuojiProductModel *)initCellModelWithMessage:(DuojiProductMessage *)message
...
- (MQChatBaseCell *)getCellWithReuseIdentifier:(NSString *)cellReuseIdentifer {
    return [[DuojiProductCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellReuseIdentifer];
}
