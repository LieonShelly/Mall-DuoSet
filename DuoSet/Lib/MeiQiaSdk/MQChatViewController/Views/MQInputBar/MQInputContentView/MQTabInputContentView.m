...
-(instancetype)initWithFrame:(CGRect)frame;
{
    ...
    if (self) {
        ...
        self.textField.placeholder = @"快来打个招呼吧";
        ...
        footBoder = [CALayer layer];
        footBoder.backgroundColor = [UIColor colorWithRed:198/255.0 green:203/255.0 blue:208/255.0 alpha:1].CGColor;
        [self.layer addSublayer:footBoder];
...
-(void)setNeedsLayout
{
    ...
    topBoder.frame = CGRectMake(0, 0, self.frame.size.width, 0.5);
    footBoder.frame = CGRectMake(0, self.frame.size.height, self.frame.size.width, 0.5);
}
