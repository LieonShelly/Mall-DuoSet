...
- (void)setImageURLStringsGroup:(NSArray *)imageURLStringsGroup scrollToFirst:(BOOL)scrollToFirst{
    _imageURLStringsGroup = imageURLStringsGroup;
...
- (void)scrollToIndex:(int)targetIndex
{
    ...
    [_mainView scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:targetIndex inSection:0] atScrollPosition:UICollectionViewScrollPositionNone animated:_scrollAnimation];
}
