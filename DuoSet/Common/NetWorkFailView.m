...
@implementation NetWorkFailView
...
- (void)updateConstraints{
    if (!_didUpdateConstraints) {
        ...
        [_titleLable autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_defeatedImgV withOffset:FitHeight(80.0)];
        [_titleLable autoAlignAxisToSuperviewAxis:ALAxisVertical];
        
        [_messageLable autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_titleLable withOffset:FitHeight(30.0)];
        [_messageLable autoAlignAxisToSuperviewAxis:ALAxisVertical];
        
        if (_btnName.length > 0) {
            [_backBlockBtn autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_messageLable withOffset:FitHeight(60.0)];
